# Generated by Django 5.1.1 on 2024-09-17 05:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "educational_history",
                    models.ManyToManyField(blank=True, to="userauth.educationhistory"),
                ),
                (
                    "emergency_contact",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="userauth.emergencycontact",
                    ),
                ),
                (
                    "employment_history",
                    models.ManyToManyField(blank=True, to="userauth.employmenthistory"),
                ),
                (
                    "english_test",
                    models.ManyToManyField(blank=True, to="userauth.englishtest"),
                ),
                (
                    "permanent_address",
                    models.ForeignKey(
