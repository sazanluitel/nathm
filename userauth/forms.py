    ...
    class Meta:
        ...
        widgets = {
            ...
            "date_of_birth_in_ad": forms.DateInput(
                attrs={
                    "class": "form-control date-picker-english",
                    "id": "date_of_birth_in_ad",
                    "type": "date",
                    "placeholder": "Date of Birth",
                }
            ),
            "date_of_birth_in_bs": forms.TextInput(
            attrs={'class': 'form-control date-picker', 'id': 'date_of_birth_in_bs', 'name':'date', 'placeholder': 'Date of Birth (BS)'}),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "city": forms.TextInput(
                attrs={"class": "form-control", "id": "city", "placeholder": "City"}
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "file": forms.TextInput(
                attrs={"class": "form-control", "id": "file", "placeholder": "File URL"}
            ),
        }
        ...
        widgets = {
            "test": forms.Select(
                attrs={
                    ...
                    "id": "test",
                    "data-placeholder": "Select test type",
                }
            ),
            "score": forms.NumberInput(
                attrs={"class": "form-control", "id": "score", "placeholder": "Score"}
            ),
